...
function ViewProductByCategoryComp() {
    ...
    const fetchProducts = async () => {
      try {
        const response = await axios.post(
          `https://eonic.nimesh.engineer/user/getProductByCategory`,
          {
            categoryId,
          }
        );
                    ...
                    <div className="product-item bg-light mb-4">
                      <div className="product-img position-relative overflow-hidden">
                        <img
                          ...
                          src={`https://eonic.nimesh.engineer/images/productImage/${product.productImgs[0]}`}
...
export default ViewProductByCategoryComp;
