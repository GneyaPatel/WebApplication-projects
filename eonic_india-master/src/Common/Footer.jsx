  ...
  useEffect(() => {
    const fetchContactData = async () => {
      const response = await axios.post(
        `https://eonic.nimesh.engineer/user/getContactDetail`
      );
      ...
      <div className="container-fluid bg-dark text-secondary pt-5">
        <div className="row px-xl-5 pt-5">
          <div className="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
            ...
            <p className="mb-4">
              Contact us if you need any help regarding our products or services
              or if you have any queries. We are always happy to help.
            </p>
            <p className="mb-2">
